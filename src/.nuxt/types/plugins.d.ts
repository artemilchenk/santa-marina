...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../plugins/01.gtm.client").default> &
  InjectionType<typeof import("../../plugins/02.analytics.client").default> &
  InjectionType<typeof import("../../plugins/04.userback.client").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'nuxt:webpack-preload' | 'nuxt:chunk-reload' | 'nuxt:checkIfLayoutUsed'
  }
}
