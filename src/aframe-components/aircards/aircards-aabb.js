// SOURCE: https://github.com/supermedium/superframe/tree/master/components/aabb-collider
...
export const AabbCollider = {
  ...
  init: function init () {
    ...
    this.observer = new MutationObserver(this.setDirty) // eslint-disable-line
    this.dirty = true
  ...
  tick: function tick (time) {
    ...
    let closestCenterDifference = void 0 // eslint-disable-line
    let newClosestEl = void 0 // eslint-disable-line
    let i = void 0 // eslint-disable-line
...
*/
  isIntersecting: (function () {
    ...
    return function (el) {
      let box = void 0 // eslint-disable-line
